...
# 
@torch.no_grad()
def run(weights='C:/DEV_TOOL/yolov5/yolov5s.pt',  # model.pt path(s)
        source='C:/DEV_TOOL/yolov5/data/images/fooddataset/test/images/jjajangmyeon_1.jpg',  # file/dir/URL/glob, 0 for webcam
